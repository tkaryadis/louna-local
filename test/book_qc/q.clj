...
#_(q {:q-in ["ex069"] :q-out ["print"]}
     [?last ?first ?CourseName]
     (:ab.firstName ?student ?first)
     (:ab.lastName ?student ?last)
...
#_(q {:q-in ["ex122-123"] :q-out ["print"]}
     [?email]
     (:ab.email ?s ?email))
...
[58]
;;sparql_query=1.rq
#_(q {:q-in ["spValues1"] :q-out ["print"]}
